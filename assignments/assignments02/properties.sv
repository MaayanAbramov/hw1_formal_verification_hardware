...
sequence sQ7;
    (direction == UP) throughout (currentFloor[0] == 1 ##1 ( engineOp == STOP && doorsOp == OPEN && currentFloor == $past(currentFloor << 1)[->FLOORS-1]));
endsequence
...
// QUESTION 7:
property prop_Q7;
    @(posedge clk)  all_floors_up sQ7;  // EDIT THIS LINE
endproperty
